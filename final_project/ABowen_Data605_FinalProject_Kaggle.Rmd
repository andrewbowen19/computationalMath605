...
Let's now [construct a 95% confidence interval](https://www.r-bloggers.com/2021/11/calculate-confidence-intervals-in-r/) from our Kaggle variable `MasVnrArea`. To do this we'll need our sample mean and standard deviation for this field
```{r conf-interval}
