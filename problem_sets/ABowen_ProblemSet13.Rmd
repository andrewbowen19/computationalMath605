...
\begin{aligned}
  N(t) = \int \frac{-3150}{t^4} - 220 \,dx = \frac{3150}{4t^5} + C
\end{aligned}
...
(C <- 6530 - (3150 / 4))
```
Making our final expression for the number of bacteria per day: $N(t) = \frac{3150}{t^5} + 5742.5$
```{r bacteria-check}
N <- function(t){
  3150/(t^5) + C
}
...
\begin{aligned}
  S(x) = 3.75x\newline
  \Gamma(x) = 8.75\frac{110}{x}
\end{aligned}

Let the total cost function be $C(x) = S(x) + \Gamma(x) = 3.75x + \frac{962.5}{x}$. To find a minimal cost as a function of flat irons ordered, we'll need to find where $C'(x) = 0$

\begin{aligned}
  C'(x) = 3.75 - \frac{962.5}{x^2}\newline
      0 = 3.75 - \frac{962.5}{x^2}\newline
      3.75 = \frac{962.5}{x^2}
      x = 16.02
\end{aligned}
...
\begin{aligned}
  \int u\,dv = uv - \int v\,du\newline
             = \ln(9x)x^6 - \int x^6\frac{9}{x}\,dx\newline
             =  \ln(9x)x^6 - 9\int x^5 \,dx\newline
             =  \ln(9x)x^6 - \frac{3}{2}x^6 + C
\end{aligned}
